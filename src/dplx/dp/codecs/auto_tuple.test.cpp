...
{
    item_sample<test_tuple> const sample{
    ...
    REQUIRE(dp::encode_tuple<test_tuple_def_1>(ctx, sample.value));
...
TEST_CASE("encode tuple with layout descriptor 2")
{
    ...
    REQUIRE(dp::encode_tuple<test_tuple_def_2>(ctx, sample.value));
...
TEST_CASE("encode tuple with layout descriptor 3")
{
    ...
    REQUIRE(dp::encode_tuple<test_tuple_def_3>(ctx, sample.value));
...
TEST_CASE("encode tuple with layout descriptor 4")
{
    ...
    REQUIRE(dp::encode_tuple<test_tuple_def_4>(ctx, sample.value));
...
TEST_CASE("encode tuple with layout descriptor 5")
{
    ...
    REQUIRE(dp::encode_tuple<test_tuple_def_5>(ctx, sample.value));
